...
const {handleHtmlFileRead, readFromFile} = require('../config/utils');
...
module.exports = (req, res) => {
    ...
    if (pathname === '/cats/add-cat' && req.method === 'GET') {
       filePath = path.normalise(path.join(__dirname, '../views/add-cat.html'));
       fs.readFile('./data/breeds.json', (err, data) => {
        ...
        form.parse(req, (err, fields, files) => {
            ...
            const newPath = path.normalise(path.join(__dirname.replace( '\\handlers', '')) + files.upload.name);
    ...
    } else if (path=name === '/cats/add-breed' && req.method === 'POST') {
        let formData = '';
