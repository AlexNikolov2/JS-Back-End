...
const { getAll, sharePublication, getUsersPublications, findUsersShared } = require('../services/publications');
...
router.get('/profile', isUser(), async (req, res) => {
    const userPubls = await getUsersPublications(res.locals.user._id);
